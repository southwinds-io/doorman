...
type Command struct {
	...
	Name string `bson:"_id" json:"name" yaml:"name" example:"clamscan"`
	// the command description
	Description string `bson:"description" yaml:"description" json:"description" example:"scan files in specified path"`
	// the value of the command
	Value string `bson:"value" json:"value" yaml:"value" example:"freshclam && clamscan -r ${path}"`
