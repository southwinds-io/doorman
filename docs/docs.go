...
const docTemplate = `{
    ...
    "definitions": {
        ...
        "types.CMDB": {
            ...
            "properties": {
                "catalogue": {
                    "description": "Catalogue flag indicating if catalogue item should be created",
                    "type": "boolean"
                },
                "events": {
                    "description": "Events that should be added to the CMDB once the spec has been received (e.g. SETUP, DEPLOY, DECOM)",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
                ...
                "tag": {
                    "description": "Tag list of tags to be added to the catalogue",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
        ...
        "types.ImageRegistry": {
            ...
            "properties": {
                ...
                "group": {
                    "description": "Group the group (location within the registry) where the packages should be placed\nif not specified, the group from the package to push is used",
                    "type": "string",
                    "example": "test/groupA"
                },
                "pwd": {
        ...
        "types.PipelineConf": {
            ...
            "properties": {
                ...
                "cmdb": {
                    "description": "CMDB the configuration of the configuration management database operations to be carried out on receipt of the spec",
                    "$ref": "#/definitions/types.CMDB"
                },
                "commands": {
        ...
        "types.S3Store": {
            ...
            "properties": {
                "account_id": {
                    "description": "AccountID the ID of the AWS account that owns the resource, without the hyphens",
                    "type": "string"
                },
                "bucket_uri": {
                ...
                "partition": {
                    "description": "ARN parts required to create a bucket notification\nPartition",
                    "type": "string"
                },
                "pwd": {
                ...
                "region": {
                    "description": "Region the Region code (e.g. empty for standard minio implementations)",
                    "type": "string"
                },
                "resource": {
                    "description": "Resource The resource identifier. This part of the ARN can be the name or ID of the resource or a resource path\n(e.g. \"webhook\" for standard minio webhooks)",
                    "type": "string"
                },
                "service": {
                    "description": "Service the service namespace that identifies the AWS product (e.g. minio for standard minio implementations)",
                    "type": "string"
                },
                "user": {
